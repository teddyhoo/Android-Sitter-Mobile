...
public class ExifTag {
     ...
     * </ul>
     *
     * @see android.util.Rational
     */
    public boolean setValue(android.util.Rational[] value) {
        if (checkBadComponentCount(value.length)) {
            return false;
        }
     ...
     */
    public boolean setValue(android.util.Rational value) {
        return setValue(new android.util.Rational[] {
                value
        });
    }
    /**
    ...
    public boolean setValue(Object obj) {
        ...
        } else if (obj instanceof android.util.Rational) {
            return setValue((android.util.Rational) obj);
        } else if (obj instanceof android.util.Rational[]) {
            return setValue((android.util.Rational[]) obj);
    ...
    public Rational[] getValueAsRationals() {
        if (mValue instanceof android.util.Rational[]) {
    ...
    public Rational getValueAsRational(long defaultValue) {
        Rational defaultVal = new Rational((int)defaultValue, 1);
     ...
     *                {@link #TYPE_RATIONAL} or {@link #TYPE_UNSIGNED_RATIONAL}.
     */
    protected android.util.Rational getRational(int index) {
        if (mDataType != TYPE_RATIONAL && mDataType != TYPE_UNSIGNED_RATIONAL) {
            throw new IllegalArgumentException("Cannot get RATIONAL value from "
                    + convertTypeToString(mDataType));
        }
        return ((android.util.Rational[]) mValue)[index];
    }
    /**
    ...
    private boolean checkOverflowForUnsignedRational(android.util.Rational[] value) {
        for (android.util.Rational v : value) {
    ...
    private boolean checkOverflowForRational(android.util.Rational[] value) {
        for (android.util.Rational v : value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExifTag) {
            ...
            if (mValue != null) {
                ...
                } else if (mValue instanceof android.util.Rational[]) {
                    if (!(tag.mValue instanceof android.util.Rational[])) {
                        return false;
                    }
                    return Arrays.equals((android.util.Rational[]) mValue, (android.util.Rational[]) tag.mValue);
                } else if (mValue instanceof byte[]) {
