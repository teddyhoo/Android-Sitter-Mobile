...
class ExifModifier {
                    ...
                    case ExifParser.EVENT_NEW_TAG:
                        ...
                        if (newTag != null) {
                            if (newTag.getComponentCount() != oldTag.getComponentCount()
                                ...
                                mTagOffsets.add(new ExifModifier.TagOffset(newTag, oldTag.getOffset()));
    ...
    private void modify() {
        ...
        for (ExifModifier.TagOffset tagOffset : mTagOffsets) {
        ...
        switch (tag.getDataType()) {
            ...
            case ExifTag.TYPE_UNSIGNED_RATIONAL:
                for (int i = 0, n = tag.getComponentCount(); i < n; i++) {
                    ...
                    mByteBuffer.putInt(v.getNumerator());
                    mByteBuffer.putInt(v.getDenominator());
                }
                break;
